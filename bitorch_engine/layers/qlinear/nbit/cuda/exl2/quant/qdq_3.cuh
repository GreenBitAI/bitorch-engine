...
)
{
    ...
    const half z8_  = __float2half_rn(-1024.0f /  8.0f);
    const half z64_ = __float2half_rn(-1024.0f / 64.0f);
...
{
    half dqh[32];
    for (int i = 0; i < 10; i++) dqh[     i] = dq_ns(exb(     q_0, i * 3    , 0x07), 0);
                                 dqh[10    ] = dq_ns(exb(q_1, q_0,        30, 0x07), 0);
    for (int i = 0; i < 10; i++) dqh[11 + i] = dq_ns(exb(     q_1, i * 3 + 1, 0x07), 0);
                                 dqh[21    ] = dq_ns(exb(q_2, q_1,        31, 0x07), 0);
    for (int i = 0; i < 10; i++) dqh[22 + i] = dq_ns(exb(     q_2, i * 3 + 2, 0x07), 0);
