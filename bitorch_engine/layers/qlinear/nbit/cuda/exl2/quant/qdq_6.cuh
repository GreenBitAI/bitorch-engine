...
{
    half dqh[16];
    for (int i = 0; i < 5; i++) dqh[     i] = dq_ns(exb(     q_0, i * 6    , 0x3f), 0);
                                dqh[ 5    ] = dq_ns(exb(q_1, q_0,        30, 0x3f), 0);
    for (int i = 0; i < 4; i++) dqh[ 6 + i] = dq_ns(exb(     q_1, i * 6 + 4, 0x3f), 0);
                                dqh[10    ] = dq_ns(exb(q_2, q_1,        28, 0x3f), 0);
    for (int i = 0; i < 5; i++) dqh[11 + i] = dq_ns(exb(     q_2, i * 6 + 2, 0x3f), 0);
