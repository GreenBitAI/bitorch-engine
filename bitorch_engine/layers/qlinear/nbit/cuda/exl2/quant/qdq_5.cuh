...
)
{
    ...
    const half z1_  = __float2half_rn(-1024.0f);
    const half z32_ = __float2half_rn(-1024.0f / 32.0f);
...
{
    half dqh[32];
    for (int i = 0; i <  6; i++) dqh[     i] = dq_ns(exb(     q_0, i * 5    , 0x1f), 0);
                                 dqh[ 6    ] = dq_ns(exb(q_1, q_0,        30, 0x1f), 0);
    for (int i = 0; i <  5; i++) dqh[ 7 + i] = dq_ns(exb(     q_1, i * 5 + 3, 0x1f), 0);
                                 dqh[12    ] = dq_ns(exb(q_2, q_1,        28, 0x1f), 0);
    for (int i = 0; i <  6; i++) dqh[13 + i] = dq_ns(exb(     q_2, i * 5 + 1, 0x1f), 0);
                                 dqh[19    ] = dq_ns(exb(q_3, q_2,        31, 0x1f), 0);
    for (int i = 0; i <  5; i++) dqh[20 + i] = dq_ns(exb(     q_3, i * 5 + 4, 0x1f), 0);
                                 dqh[25    ] = dq_ns(exb(q_4, q_3,        29, 0x1f), 0);
    for (int i = 0; i <  6; i++) dqh[26 + i] = dq_ns(exb(     q_4, i * 5 + 2, 0x1f), 0);
